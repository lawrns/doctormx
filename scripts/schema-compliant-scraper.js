...
// Save doctors to database with correct schema only
async function saveDoctorsToDatabase(doctors) {
  ...
  for (const doctor of doctors) {
    try {
      ...
      // Then, create or update doctor record with ONLY existing schema columns
...
async function main() {
  console.log('🇲🇽 Schema Compliant Doctor Scraper');
  console.log('===================================');
