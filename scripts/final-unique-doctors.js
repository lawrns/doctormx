...
// Create sample doctors from the scraped data with unique identifiers
  ...
  const sampleDoctors = [
    {
      ...
      email: generateUniqueEmail('Dr. Roy Martony Pérez Cambero')
    },
    {
      ...
      subscription_plan: 'premium',
      phone: generateUniquePhone(),
      email: generateUniqueEmail('Dr. Hiram Vela Vizcaino')
    },
    {
      ...
      subscription_plan: 'premium',
      phone: generateUniquePhone(),
      email: generateUniqueEmail('Dr. Jose Abraham Navarrete Garcia')
    },
    {
      ...
      subscription_plan: 'premium',
      phone: generateUniquePhone(),
      email: generateUniqueEmail('Dr. Heriberto Pruneda Ayala')
    },
    {
      ...
      subscription_plan: 'premium',
      phone: generateUniquePhone(),
      email: generateUniqueEmail('Dr. Mario Ramón García Arias')
    },
    {
      ...
      subscription_plan: 'premium',
      phone: generateUniquePhone(),
      email: generateUniqueEmail('Dr. Norman Said Vega Servín')
    },
    {
      ...
      subscription_plan: 'premium',
      phone: generateUniquePhone(),
      email: generateUniqueEmail('Dr. Gerardo Arteaga Cárdenas')
    },
    {
      ...
      subscription_plan: 'premium',
      phone: generateUniquePhone(),
      email: generateUniqueEmail('Dr. Antonio Ruiz Rivera')
    },
    {
      ...
      subscription_plan: 'premium',
      phone: generateUniquePhone(),
      email: generateUniqueEmail('Dr. Julio Cesar Mayen Casas')
    },
    {
      ...
      subscription_plan: 'premium',
      phone: generateUniquePhone(),
      email: generateUniqueEmail('Dr. José Raúl Cruz Mendoza')
    }
  ];
...
async function main() {
  console.log('🇲🇽 Final Unique Doctors Scraper');
  console.log('================================');
