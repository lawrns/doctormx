...
Call log:
  ...
  - waiting for locator('textarea[placeholder*="Cuéntame qué te duele"]')
    ...
    at /Users/excite/Documents/GitHub/doctormx/e2e/responsive-design.spec.ts:151:86
```
...
> 151 |         await expect(page.locator('textarea[placeholder*="Cuéntame qué te duele"]')).toBeVisible();
      |                                                                                      ^ Error: Timed out 5000ms waiting for expect(locator).toBeVisible()
  152 |       }
  153 |     });
  154 |   });
