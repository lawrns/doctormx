...
- Name: Responsive Design Tests >> AI Doctor Page Responsiveness >> should render correctly on Tablet Landscape (1024x768)
...
Call log:
  ...
  - waiting for locator('input[placeholder*="síntomas"]')
    ...
    at /Users/excite/Documents/GitHub/doctormx/e2e/responsive-design.spec.ts:50:70
```
...
- text: "ReferenceError: LabTestingPage is not defined"
- button "Reintentar"
- button "Volver"
```
