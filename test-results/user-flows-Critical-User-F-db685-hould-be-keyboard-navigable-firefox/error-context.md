...
- Name: Critical User Flows >> Accessibility >> should be keyboard navigable
- Location: /Users/excite/Documents/GitHub/doctormx/e2e/user-flows.spec.ts:157:9
...
Call log:
  ...
  - waiting for locator('input[placeholder*="síntomas"]')
    9 × locator resolved to <input value="" type="text" placeholder="Describe tus síntomas..." class="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#006D77] focus:border-transparent"/>
      - unexpected value "inactive"

    at /Users/excite/Documents/GitHub/doctormx/e2e/user-flows.spec.ts:166:27
```
