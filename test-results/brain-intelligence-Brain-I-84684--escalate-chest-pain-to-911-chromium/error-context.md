...
- Name: Brain Intelligence Upgrades >> Emergency Detection (CRITICAL) >> should immediately escalate chest pain to 911
- Location: /Users/excite/Documents/GitHub/doctormx/e2e/brain-intelligence.spec.ts:21:9
...
Call log:
  - waiting for locator('textarea[placeholder*="Cuéntame qué te duele o preocupa"]')
    ...
    at /Users/excite/Documents/GitHub/doctormx/e2e/brain-intelligence.spec.ts:24:19
```
