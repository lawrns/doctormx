...
- Name: Critical User Flows >> Navigation Flow >> should handle direct URL access
- Location: /Users/excite/Documents/GitHub/doctormx/e2e/user-flows.spec.ts:91:9

# Error details

```
Error: expect.not.toBeVisible: Error: strict mode violation: locator('text=Error') resolved to 2 elements:
    1) <p class="mt-2 text-gray-600">Ha ocurrido un error en esta sección. Puedes inte…</p> aka getByText('Ha ocurrido un error en esta')
    2) <pre>ReferenceError: AnalysisPage is not defined</pre> aka getByText('ReferenceError: AnalysisPage')

Call log:
  - expect.not.toBeVisible with timeout 5000ms
  - waiting for locator('text=Error')

    at /Users/excite/Documents/GitHub/doctormx/e2e/user-flows.spec.ts:100:54
```
