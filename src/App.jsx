        ...
        <section className="relative mx-auto max-w-container px-4 py-12 md:py-20 lg:py-24 md:px-6 lg:px-8 overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
            <div className={`transition-all duration-700 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              ...
              {/* Dr. Simeon Featured */}
              <div className="bg-gradient-to-r from-primary-50/80 to-accent-50/60 rounded-2xl p-6 mb-8 border border-primary-100/50 shadow-lg">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-bold text-neutral-900">Dr. Simeon</h3>
                    <p className="text-sm text-neutral-600 mb-2">Médico General • Nuestro Doctor de Casa</p>
