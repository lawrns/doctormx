...
import { Calendar, MessageCircle, User, ClipboardList, Image as ImageIcon, Sparkles, Users, Home, Stethoscope, LogOut, Bot, LayoutDashboard, Menu, X, ArrowRight } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <aside className="hidden lg:flex flex-col w-64 bg-white border-r border-gray-200 h-screen sticky top-0">
        ...
        {/* Buscar Doctores Button - Light blue at bottom */}
        <div className="px-4 pb-4">
          <Link href="/doctors" className="block">
            <Button className="w-full h-12 bg-sky-100 hover:bg-sky-200 text-sky-700 font-semibold rounded-xl transition-all duration-200 hover:scale-[1.02] shadow-sm hover:shadow-md">
      ...
      >
        ...
        {/* Buscar Doctores Button - Light blue at bottom (mobile) */}
        <div className="px-4 pb-4">
          <Link href="/doctors" onClick={() => setMobileMenuOpen(false)} className="block">
            <Button className="w-full h-12 bg-sky-100 hover:bg-sky-200 text-sky-700 font-semibold rounded-xl transition-all duration-200 hover:scale-[1.02] shadow-sm hover:shadow-md">
              <span className="flex items-center justify-center gap-2">
                <Stethoscope className="w-5 h-5" />
                Buscar Doctores
