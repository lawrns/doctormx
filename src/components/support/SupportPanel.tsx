      ...
      <div className="relative shrink-0 border-b border-border px-4 pb-3 pt-4">
        ...
        <div className="flex items-center justify-between gap-2">
          <div className="flex items-center gap-2">
            ...
            <div className="inline-flex items-center gap-1.5 rounded-lg border border-[hsl(var(--brand-ocean)/0.20)] bg-[hsl(var(--brand-ocean)/0.10)] px-2.5 py-0.5 text-[11px] font-semibold uppercase tracking-[0.14em] text-[hsl(var(--brand-ocean))]">
