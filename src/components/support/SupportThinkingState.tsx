...
export function SupportThinkingState() {
  ...
  return (
    <div className="rounded-2xl border border-primary/15 bg-primary/5 p-4 shadow-[0_10px_30px_hsl(var(--shadow-color)/0.08)]">
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-sm font-medium text-foreground">Simeon está pensando…</p>
