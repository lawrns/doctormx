...
function DrSimeonAvatar() {
  return (
    <motion.div
      className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-blue-500 to-blue-600 text-white shadow-md"
      animate={{
        scale: [1, 1.05, 1],
      }}
      transition={{
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          >
            ...
            <ul className="space-y-3">
              {[
                'Evaluación de síntomas en 5 minutos',
                'Detección de emergencias médicas',
                'Recomendación de especialista ideal',
                'Disponible 24/7, siempre contigo',
              ].map((feature, index) => (
                <motion.li
                  key={index}
