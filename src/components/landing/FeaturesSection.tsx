      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {features.map((feature, index) => (
            ...
            >
              <Card
                className="h-full p-5 sm:p-6 lg:p-8 hover:shadow-xl interactive group cursor-pointer relative overflow-hidden border-neutral-200/60 bg-white focus-within:ring-2 focus-within:ring-primary-500 focus-within:ring-offset-2"
                tabIndex={0}
                role="article"
