...
export function StatsSection() {
  ...
  return (
    <section className="public-section-compact bg-gradient-to-b from-neutral-0 to-neutral-50 relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          <PublicSectionHeading
            ...
            accent="nuestra misión"
            description="Datos actualizados • Enero 2025"
          />
        </motion.div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="text-4xl sm:text-5xl font-bold text-[hsl(var(--brand-ocean))] mb-2">
