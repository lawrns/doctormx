...
export const SocialIcons: React.FC<{ className?: string, iconSize?: number, iconColor?: string }> = ({ 
  className = '', 
  iconSize = 20, 
  ...
  return (
    <div className={`flex space-x-4 ${className}`}>
      <a 
        ...
        aria-label="Facebook"
      >
        <FacebookIcon size={iconSize} color={iconColor} />
      </a>
      <a 
      ...
      >
        <InstagramIcon size={iconSize} color={iconColor} />
      </a>
      <a 
      ...
      <a 
        href="https://youtube.com/c/doctormx" 
        target="_blank" 
        rel="noopener noreferrer"
        className="text-gray-500 hover:text-red-600 transition-colors"
        aria-label="YouTube"
      >
        <YouTubeIcon size={iconSize} color={iconColor} />
      </a>
    </div>
  );
};
