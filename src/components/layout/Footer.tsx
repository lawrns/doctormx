        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            <div className="flex gap-4">
              <a href="#" className="text-gray-400 hover:text-[hsl(var(--text-primary))] transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link
                  href="/doctors"
                  className="text-sm text-gray-500 hover:text-[hsl(var(--text-primary))] transition-colors"
                >
                  Buscar doctores
                </Link>
              </li>
