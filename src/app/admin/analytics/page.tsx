      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-card rounded-xl border border-border p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="font-semibold text-foreground">Tasa Conversión</h3>
          </div>
          <p className="text-3xl font-bold text-foreground">11%</p>
          <p className="text-sm text-muted-foreground mt-1">Visitantes → Citas</p>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="font-semibold text-foreground">Ticket Promedio</h3>
          </div>
          <p className="text-3xl font-bold text-foreground">{currencyFormat(revenueMetrics.averageTransaction)}</p>
        ...
        <div className="bg-card rounded-xl border border-border p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="font-semibold text-foreground">Retención</h3>
          </div>
          <p className="text-3xl font-bold text-foreground">{userMetrics.retention.rate.toFixed(1)}%</p>
          <p className="text-sm text-muted-foreground mt-1">Pacientes recurrentes</p>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="font-semibold text-foreground">Tasa Completación</h3>
          </div>
          <p className="text-3xl font-bold text-foreground">{adminMetrics.appointments.completionRate.toFixed(1)}%</p>
          <p className="text-sm text-muted-foreground mt-1">Citas finalizadas</p>
        </div>
      </div>
