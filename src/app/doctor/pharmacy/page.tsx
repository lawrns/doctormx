  ...
  return (
    <DoctorLayout profile={profile!} isPending={isPending} currentPath="/doctor/pharmacy">
      <div className="max-w-6xl">
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-text-primary mb-2">Farmacias & Ganancias</h2>
          <p className="text-text-muted">Gestiona tus referidos a farmacias y consulta tus ganancias</p>
        </div>

        {isPending ? (
          <div className="bg-warning-50 border-l-4 border-warning-400 p-6 rounded-r-lg" role="alert" aria-live="polite">
            <div className="flex items-start">
              ...
              <div className="ml-4">
                <h3 className="text-lg font-semibold text-warning-900">Sección no disponible</h3>
          ...
          <>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
              <div className="bg-card rounded-xl shadow-card border border-border p-6">
                ...
                <p className="text-sm text-text-muted mb-1">Total Referidos</p>
                <p className="text-2xl font-bold text-text-primary">{earnings.totalReferrals}</p>
              </div>
              ...
              <div className="bg-card rounded-xl shadow-card border border-border p-6">
                ...
                <p className="text-sm text-text-muted mb-1">Canjeados</p>
                <p className="text-2xl font-bold text-success-600">{earnings.redeemedReferrals}</p>
              </div>
              ...
              <div className="bg-card rounded-xl shadow-card border border-border p-6">
                ...
                <p className="text-sm text-text-muted mb-1">Pendientes</p>
                <p className="text-2xl font-bold text-warning-600">{earnings.pendingReferrals}</p>
              </div>
              ...
              <div className="bg-card rounded-xl shadow-card border border-border p-6">
                ...
                <p className="text-sm text-text-muted mb-1">Ganancias Netas</p>
                <p className="text-2xl font-bold text-accent-600">{formatCurrency(earnings.netEarnings)}</p>
              </div>
            </div>

            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="bg-card rounded-xl shadow-card border border-border p-6">
                <h4 className="font-medium text-text-primary mb-2">Tarifa por Referido</h4>
              ...
              <div className="bg-card rounded-xl shadow-card border border-border p-6">
                <h4 className="font-medium text-text-primary mb-2">Comisiones</h4>
                <p className="text-3xl font-bold text-success-600">{formatCurrency(earnings.totalCommissions)}</p>
                <p className="text-sm text-text-muted mt-1">
                  3-5% de ventas de medicamentos
                </p>
              </div>
              <div className="bg-card rounded-xl shadow-card border border-border p-6">
                <h4 className="font-medium text-text-primary mb-2">Tarifa Plataforma</h4>
                <p className="3xl font-bold text-destructive">{formatCurrency(earnings.platformFees)}</p>
                <p className="text-sm text-text-muted mt-1">
            ...
            <div className="bg-card rounded-xl shadow-card border border-border overflow-hidden">
              <div className="px-6 py-4 border-b border-border">
                <h3 className="text-lg font-semibold text-text-primary">Historial de Referidos</h3>
              </div>
              ...
              {referrals.length > 0 ? (
                  ...
                  <table className="w-full">
                    ...
                    <tbody className="divide-y divide-border">
                      {referrals.map((referral: Record<string, unknown>) => (
                        <tr key={referral.id as string} className="hover:bg-muted">
                ...
                <div className="p-8 text-center">
                  ...
                  <p className="text-text-secondary mb-2">Sin referidos aún</p>
                  <p className="text-sm text-text-muted">
            ...
            <div className="mt-8 bg-primary-50 rounded-xl p-6 border border-primary-100" role="note" aria-live="polite">
          ...
          <div className="bg-card rounded-xl shadow-card p-8 text-center">
            <p className="text-text-muted">Cargando información...</p>
          </div>
        )}
      </div>
    </DoctorLayout>
