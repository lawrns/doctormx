          ...
          <Card className="bg-card rounded-2xl border border-border shadow-dx-1">
            <CardContent className="p-6">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-10 h-10 bg-vital-soft rounded-xl flex items-center justify-center">
                  <svg className="w-5 h-5 text-vital" fill="none" viewBox="0 0 24 24" stroke="currentColor">
