  ...
  return (
    <DoctorLayout profile={profile!} isPending={isPending} currentPath="/doctor/profile">
      <div className="max-w-4xl">
        ...
        <p className="text-gray-600 mb-8">Información profesional y datos de contacto</p>
          ...
          <div className="bg-white rounded-lg shadow border p-6">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900">{doctor.rating_count || 0}</p>
              </div>
              <div>
        ...
        {isPending && (
          <div className="mt-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            <p className="text-sm text-yellow-900">
              ℹ️ Tu perfil está en revisión. Algunos campos no se pueden modificar hasta que sea aprobado.
            </p>
          </div>
        )}
      </div>
