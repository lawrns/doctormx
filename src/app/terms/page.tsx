      ...
      <section className="pt-24 pb-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none">
            <div className="bg-amber/10 border border-amber/20 rounded-xl p-6 mb-8">
              <div className="flex items-start gap-4">
                <AlertCircle className="w-6 h-6 text-amber flex-shrink-0 mt-1" />
                <div>
            ...
            <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">1. Aceptación de los Términos</h2>
            ...
            <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">2. Descripción del Servicio</h2>
            ...
            <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">3. Elegibilidad</h2>
            <p className="text-muted-foreground mb-6">
            ...
            <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">4. Uso del Servicio de IA (Dr. Simeon)</h2>
            ...
            <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">5. Responsabilidades del Usuario</h2>
            <p className="text-muted-foreground mb-4">
            ...
            <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">6. Pagos y Reembolsos</h2>
            <p className="text-muted-foreground mb-6">
            ...
            <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">7. Propiedad Intelectual</h2>
            <p className="text-muted-foreground mb-6">
            ...
            <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">8. Limitación de Responsabilidad</h2>
            <p className="text-muted-foreground mb-6">
            ...
            <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">9. Modificaciones</h2>
            <p className="text-muted-foreground mb-6">
              Nos reservamos el derecho de modificar estos términos en cualquier momento.
              Los cambios serán notificados a través de la plataforma.
            </p>

            <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">10. Contacto</h2>
            <p className="text-muted-foreground mb-6">
              Para preguntas sobre estos términos, contacta a: <a href="mailto:legal@doctor.mx" className="text-primary hover:underline">legal@doctor.mx</a>
            </p>
