        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-4">
              <h1 className="text-2xl font-bold text-foreground">Doctor.mx</h1>
            ...
            <div className="flex items-center gap-4">
              <span className="text-sm text-muted-foreground">{pharmacy.name}</span>
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="bg-card rounded-lg shadow mb-8">
          ...
          <div className="p-6">
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h4 className="font-medium text-foreground mb-2">{pharmacy.name}</h4>
                <p className="text-sm text-muted-foreground">{pharmacy.address}</p>
                <p className="text-sm text-muted-foreground">{pharmacy.city}, {pharmacy.state}</p>
                <p className="text-sm text-muted-foreground mt-2">Email: {pharmacy.contact_email}</p>
                {pharmacy.contact_phone && (
                  <p className="text-sm text-muted-foreground">Teléfono: {pharmacy.contact_phone}</p>
                )}
              </div>
              <div>
                <h4 className="font-medium text-foreground mb-2">Comisiones</h4>
                <p className="text-sm text-muted-foreground">Tarifa de Comisión: {pharmacy.commission_rate}%</p>
                <p className="text-sm text-muted-foreground">Tarifa Fija por Referido: {formatCurrency(pharmacy.fixed_fee_cents)}</p>
        ...
        <div className="bg-card rounded-lg shadow">
          <div className="px-6 py-4 border-b flex justify-between items-center">
            ...
            <span className="text-sm text-muted-foreground">{referrals.length} referidos</span>
          </div>
