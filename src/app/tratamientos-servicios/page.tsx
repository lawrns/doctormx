              ...
              >
                <Card className="relative p-6 h-full bg-white/70 backdrop-blur-sm border-neutral-100 hover:shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] transition-all duration-200 group-hover:border-blue-200 group-hover:-translate-y-1">
                  <div className="space-y-3">
                    {treatment.category && (
                      <span className="inline-block text-[10px] font-semibold uppercase tracking-wider px-2.5 py-1 rounded-full bg-blue-50 text-blue-600">
                        {treatment.category}
                      </span>
                    )}
          ...
          <div className="flex flex-wrap gap-2 mb-8">
            {sortedCategories.map((category) => (
              <a
                ...
                className="px-4 py-2 rounded-lg bg-white border border-neutral-100 text-sm font-medium text-neutral-600 hover:bg-blue-600 hover:text-white hover:border-blue-600 transition-all"
              >
                {category}
              </a>
            ))}
