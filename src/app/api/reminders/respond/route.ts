...
<head>
  ...
  <style>
    ...
    .card { background: white; padding: 48px; border-radius: 16px; box-shadow: 0 4px 14px rgba(15,37,95,.1); text-align: center; max-width: 420px; width: 90%; }
    ...
    .btn { display: inline-block; padding: 12px 24px; background: #1a3ab8; color: white; text-decoration: none; border-radius: 10px; font-weight: 500; font-size: 14px; }
  </style>
</head>
<body>
  <div class="card">
