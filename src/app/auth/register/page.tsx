        ...
        <div className="w-full max-w-md">
          <Card className="p-8 shadow-xl border-neutral-200">
            ...
            <div className="text-center mb-8">
              <div className={`w-16 h-16 ${isDoctor ? 'bg-green-50' : 'bg-primary-50'} rounded-2xl flex items-center justify-center mx-auto mb-4`}>
                {isDoctor ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <Button
                type="submit"
                disabled={loading}
                className={`w-full h-12 font-semibold text-base ${isDoctor ? 'bg-green-600 hover:bg-green-700' : 'bg-primary-500 hover:bg-[#0052A3]'}`}
              >
                {loading ? (
            ...
            <p className="text-xs text-gray-400 text-center mt-4">
              ...
              <Link href="/terms" className="text-primary-500 hover:underline">Términos</Link>
              {' '}y{' '}
