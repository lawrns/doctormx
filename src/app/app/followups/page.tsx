  ...
  return (
    <div className="min-h-screen bg-gradient-hero">
      <header className="glass-nav sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-2xl font-bold text-ink-primary">Doctory</span>
          </Link>
          <div className="flex items-center gap-4">
            <Link href="/app" className="text-sm text-primary-600 hover:text-primary-700 font-medium">
              Volver al inicio
            </Link>
          </div>
        </div>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-ink-primary mb-2">Mis Seguimientos</h1>
          <p className="text-lg text-ink-secondary">
            Revisa el estado de tus seguimientos y respuestas
          </p>
        </div>
