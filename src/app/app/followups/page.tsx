  ...
  return (
    <div className="p-6 lg:p-8">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-text-primary mb-2">Mis Seguimientos</h1>
          <p className="text-lg text-text-muted">Revisa el estado de tus seguimientos y respuestas</p>
        </div>

        {followUps.length === 0 ? (
          <div className="bg-background rounded-2xl shadow-card border border-border p-12 text-center">
            {/* Icon */}
            ...
            {/* Heading */}
            <h3 className="text-xl font-bold text-text-primary mb-3">No tienes seguimientos programados</h3>
            ...
            <div className="flex items-center justify-center gap-4 mb-8 max-w-lg mx-auto">
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="text-xs text-text-muted font-medium">1. Consulta</span>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="text-xs text-text-muted font-medium">2. WhatsApp</span>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="text-xs text-text-muted font-medium">3. Doctor alertado</span>
              </div>
            </div>
            ...
            <Link
              href="/doctors"
              className="inline-flex items-center gap-2 bg-primary text-white px-6 py-3 rounded-xl font-medium hover:bg-primary/90 transition-colors duration-200 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
            >
              Buscar un doctor
          ...
          <div className="space-y-4">
            {followUps.map((followUp) => (
              <div
                key={followUp.id}
                className="bg-background rounded-2xl shadow-card border border-border p-6 hover:shadow-card-hover transition-shadow duration-200"
              >
