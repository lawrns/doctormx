/**
 * Medical Guidelines Catalog
 * Mexican medical guidelines, NOMs, and clinical protocols
 * Based on IMSS, ISSSTE, CENETEC, and WHO guidelines
 */

import { MedicalGuideline } from '../types';

// General Medicine Guidelines
export const GENERAL_GUIDELINES: MedicalGuideline[] = [
  {
...
export const CARDIOLOGY_GUIDELINES: MedicalGuideline[] = [
  {
...
export const ENDOCRINOLOGY_GUIDELINES: MedicalGuideline[] = [
  {
...
export const PULMONOLOGY_GUIDELINES: MedicalGuideline[] = [
  {
...
export const GASTROENTEROLOGY_GUIDELINES: MedicalGuideline[] = [
  {
...
export const NEUROLOGY_GUIDELINES: MedicalGuideline[] = [
  {
...
export const DERMATOLOGY_GUIDELINES: MedicalGuideline[] = [
  {
...
// Infectology Guidelines
export const INFECTOLOGY_GUIDELINES: MedicalGuideline[] = [
  {
...
export const PSYCHIATRY_GUIDELINES: MedicalGuideline[] = [
  {
...
export const RHEUMATOLOGY_GUIDELINES: MedicalGuideline[] = [
  {
...
export const NEPHROLOGY_GUIDELINES: MedicalGuideline[] = [
  {
...
// Urology Guidelines
export const UROLOGY_GUIDELINES: MedicalGuideline[] = [
  {
...
export const OPHTHALMOLOGY_GUIDELINES: MedicalGuideline[] = [
  {
...
// Otorhinolaryngology Guidelines
export const ENT_GUIDELINES: MedicalGuideline[] = [
  {
...
export const GERIATRICS_GUIDELINES: MedicalGuideline[] = [
  {
...
export const GYNECOLOGY_GUIDELINES: MedicalGuideline[] = [
  {
...
export const PEDIATRICS_GUIDELINES: MedicalGuideline[] = [
  {
...
export const EMERGENCY_GUIDELINES: MedicalGuideline[] = [
  {
...
export const PREVENTIVE_GUIDELINES: MedicalGuideline[] = [
  {
...
// Pain Medicine Guidelines
export const PAIN_GUIDELINES: MedicalGuideline[] = [
  {
...
export const TRAUMATOLOGY_GUIDELINES: MedicalGuideline[] = [
  {
...
// Combined array of all guidelines
export const ALL_GUIDELINES: MedicalGuideline[] = [
  ...GENERAL_GUIDELINES,
...
// Guidelines by specialty map
export const GUIDELINES_BY_SPECIALTY: Record<string, MedicalGuideline[]> = ALL_GUIDELINES.reduce(
  (acc, guideline) => {
    const specialty = guideline.specialty;
    if (!acc[specialty]) {
      acc[specialty] = [];
    }
    acc[specialty].push(guideline);
    return acc;
  },
  {} as Record<string, MedicalGuideline[]>
);
