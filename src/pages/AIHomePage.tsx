          ...
          <div className="md:flex md:items-center md:space-x-12">
            <div className="md:w-1/2 text-center md:text-left">
              <h1 className="text-4xl md:text-5xl font-bold text-white leading-tight">
                Tu asistente médico <span className="text-blue-200">inteligente</span>
              </h1>
                ...
                <div className="relative z-10 bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-2xl p-6 shadow-xl border border-white border-opacity-20">
                  <div className="flex items-center space-x-4 mb-4">
                    ...
                    <div className="text-white">
                      ...
                      <p className="text-sm text-blue-100">En línea ahora</p>
                    </div>
                  </div>
      ...
      <div className="bg-blue-700">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
          <h2 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
            ...
            <span className="block text-blue-200">Comienza ahora con nuestro Doctor IA.</span>
          </h2>
